...
import com.example.cuidarte.fragmentos.Adulto_Mayor.PerfilAdultoMayorFragment;
...
public class HomeAdultoMayorActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_home_adulto_mayor);

        BottomNavigationView bottomNav = findViewById(R.id.bottom_navigation);

        // Define el comportamiento de la barra de navegación
        // Dentro de tu HomeAdultoMayorActivity.java
// ...
        bottomNav.setOnItemSelectedListener(item -> {
            ...
            if (itemId == R.id.nav_chat) {
                ...
                switchFragment(new PerfilAdultoMayorFragment());
                return true;
